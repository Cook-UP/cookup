...
class Register extends Component {
  ...
  async mySubmitHandler(e) {
    ...
    try {
      ...
      const userInfo = await Auth.signUp(params); // creation of  the new user in amazon congnito 
      ...
      const new_user ={ // formating of the user details to fix format of the mongodb database
        uID: userInfo.userSub,  // userSub is an autogenerated id made by amazon cognito
        email: this.state.username, // username and email will always be the same
        ...
        console.log(new_user);
           ...
           // cerates the user in Mongodb
    axios.post(' http://3.85.44.54:3000/users/create',new_user)
